...
/////////////////////////////
	...
	pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(g_StateCheck.Word.byte3, 0, pDataBuf);//29 ADCorrection.f32TempPFC * 100
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;

	pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(g_StateCheck.Word.byte4, 0, pDataBuf);//30 ADCorrection.f32TempPFC * 100
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;

	pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(g_StateCheck.Word.byte5, 0, pDataBuf);//31 ADCorrection.f32TempPFC * 100
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;

	pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(g_StateCheck.Word.byte6, 0, pDataBuf);//32 ADCorrection.f32TempPFC * 100
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;
	...
	pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(GetRealValue.f32VGrid * 10, 0, pDataBuf);//ADCorrection.f32VInvH * 1000 37 g_StateCheck.Word.byte6 s_u16Cnt_FanCtrl_Low_LevelHWADFault   //  swGetOutputCurrRMS_w() s_f32LoadPower_Transformer
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;

    pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(GeneralADbuffer.f32VGrid, 0, pDataBuf);//ADCorrection.f32VInvL * 100038// 2017.3.7 GX  g_MPPT_State.Word.byte0
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;
	
	pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(ADCorrection.f32IGrid * 1000, 0, pDataBuf);//39  g_StateCheck.Word.byte6 s_u16Cnt_FanCtrl_Low_LevelHWADFault   //  swGetOutputCurrRMS_w() s_f32LoadPower_Transformer
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32; 

    pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(ADCorrection.f32VGrid * 1000, 0, pDataBuf);//40// 2017.3.7 GX  g_MPPT_State.Word.byte0
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;

    pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(ADCorrection.f32IOutH * 1000, 0, pDataBuf);//41// 2017.3.7 GX  g_MPPT_State.Word.byte0
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;

    pDataBuf = &u8Scib_UserDataBuf0[bStrLen];
	bStrLen1 = sbNumToAscii(ADCorrection.f32IOutL * 1000, 0, pDataBuf);//42// 2017.3.7 GX  g_MPPT_State.Word.byte0
	bStrLen += bStrLen1;
	u8Scib_UserDataBuf0[bStrLen++] = 32;
...
int16 swGetTLineVolt(void)
{
	return( Ecan_SytemREVISED.InvH_Volt_Rms);//11
}
int16 swGetRCurr(void)
{
	return(Ecan_SytemREVISED.InvL_Volt_Rms);//12
}
