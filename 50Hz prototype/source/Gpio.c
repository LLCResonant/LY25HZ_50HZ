...
void InitGpio(void)
{
	...
	// GPIO44 Input pin for Input AC Over Current Protection IPOCP
	GpioCtrlRegs.GPBMUX1.bit.GPIO44 = 0;		// 0=GPIO  1=rsvd      2=XA4        
												// 3=XA4
	// GPIO45 Input pin for DC Bus Over Voltage Protection BUSOVP
	GpioCtrlRegs.GPBMUX1.bit.GPIO45 = 0;		// 0=GPIO  1=rsvd      2=XA5        
												// 3=XA5	
	// GPIO46 Input pin for 110V Output AC Over Current Protection OPOCP1
	GpioCtrlRegs.GPBMUX1.bit.GPIO46 = 0;		// 0=GPIO  1=rsvd      2=XA6        
												// 3=XA6
	// GPIO47 Input pin for 110V Output AC Over Voltage Protection OPOVP1
	GpioCtrlRegs.GPBMUX1.bit.GPIO47 = 0;		// 0=GPIO  1=rsvd      2=XA7        
												// 3=XA7
	// GPIO48 Output pin for Bypass Relay/SCR Control  COM4OUT
	...
	GpioCtrlRegs.GPCMUX1.bit.GPIO79 = 0;		// 0=GPIO  1=GPIO      2=XD0        
												// 3=XD0
	// GPIO80 Input pin for 220V Output AC Over Current Protection OPOCP2
	GpioCtrlRegs.GPCMUX2.bit.GPIO80 = 0;		// 0=GPIO  1=GPIO      2=XA8        
												// 3=XA8
	// GPIO81 Input pin for 220V Output AC Over Voltage Protection OPOVP2
