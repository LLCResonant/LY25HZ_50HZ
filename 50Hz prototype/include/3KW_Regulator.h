...
struct BUS_CON_REG
{
  ...
  float32   f32IGrid_RefAmp_Restrict;
...
extern	struct	INVVOLTCONTREG	InvVoltConReg;
...
extern	struct	INVVOLTCONTPARAREG	InvVoltConParaReg;
...
extern	struct	INVCURRCONTREG	InvCurrConReg;
...
extern	struct	INVCURRCONTPARAREG	InvCurrConParaReg;
...
extern	struct	PLLCONTREG	GridPLLConReg, OutPLLConReg, VOutPLLConReg;
...
extern	struct	PLL	GridPLLReg, VOutPLLReg;
...
struct INVRESTARTCHECKREG
{
	float32 temp1;
};
extern struct INVRESTARTCHECKREG InvRestartCheckReg;
/*=============================================================================*
