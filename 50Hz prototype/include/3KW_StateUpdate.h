...
union  STATE_CHECK 
{
    ...
    struct
    {
		...
		Uint16  :1;    //
		//byte 5
		Uint16  VInvUnderRating:1;    //
		Uint16  :1;    //
		Uint16  Sync_Fault1:1;    //
		Uint16  Sync_Fault2:1;    //
		Uint16  ShortInv:1;    //
		Uint16  :1;    //
		Uint16  ParallelInvOCP:1;    //
		Uint16  :1;    //
		//byte 6
		Uint16  HWADFault_IGrid_ave:1;    //B0
		Uint16  HWADFault_VGrid_ave:1;    //B1
		Uint16  HWADFault_VInv_ave:1;    //B2
		Uint16  :1;    //B3
		Uint16  HWADFault_IInv_ave:1;    //B4
		Uint16  :1;    //B5
		Uint16  HWADFault_VOut_ave:1;    //B6
		Uint16  :1;    //B7
    }bit;
}; 
...
union  SYS_WARN_MESSAGE
{
    ...
    struct
    {
        ...
        Uint16  InvAsyn:1;					// B6
        Uint16  BypassWarning:1;    		// B7
		//byte 1
        Uint16  VInvUnderRating:1;    		// B0
        Uint16  :1;      	// B1
        Uint16  :1; 						// B2
        Uint16  Inv_OverLoad:1;  			// B3
        Uint16  :1;			// B4
...
union  SYS_FAULT_MESSAGE   
{
    ...
    struct
    {
    	...
    	//byte3
        Uint16  :1;	//B0
        Uint16  unrecoverInvCurrSharFault:1;	//B1
        Uint16  :1;	//B2
        ...
        //byte4
        Uint16  Inv_OverLoad:1;   		//B0
        Uint16  :1;    	//B1
        Uint16  recoverHW_Inv_OCP:1;    	//B2
        Uint16  :1;    	//B3
        ...
        Uint16  unrecoverSW_OCP_Inv:1;			//B1
        Uint16  :1;      	//B2
        ...
        Uint16  unrecoverSW_Bus_OVP:1;   	//B1
      	Uint16  unrecoverHW_Inv_OCP:1;		//B2
       	Uint16  unrecoverSW_Inv_OVP:1;    	//B3
      	Uint16  unrecoverHW_Inv_OVP:1;    	//B4
        Uint16  :1;		//B5
        Uint16  :1;    	//B6
        Uint16  :1;    	//B7
