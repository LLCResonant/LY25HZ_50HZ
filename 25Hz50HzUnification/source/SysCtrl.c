...
//--- Configure the clocks
	SysCtrlRegs.HISPCP.all = 0x0001;		// Hi-speed periph clock prescaler
	//bit2-0, 001, HSPCLK = SYSCLKOUT/(2*HSPCLK)= 150/(2*1)= 75.0 MHz(reset default)
	//		  000, HSPCLK = SYSCLKOUT/1 = 150MHz
	
	SysCtrlRegs.LOSPCP.all = 0x0002;		// Lo-speed periph clock prescaler
	//bit2-0, 010, LSPCLK=SYSCLKOUT/(2*LOSPCLK)=150MHz/(2*2)=37.5MHz(reset defualt)
	...
	SysCtrlRegs.PCLKCR1.bit.EQEP2ENCLK = 0;		// SYSCLKOUT to eQEP2 disabled to save power
	SysCtrlRegs.PCLKCR1.bit.EQEP1ENCLK = 0;		// SYSCLKOUT to eQEP1 disabled to save power
	...
	SysCtrlRegs.PCLKCR1.bit.ECAP3ENCLK = 0;		// SYSCLKOUT to eCAP3 enabled
	SysCtrlRegs.PCLKCR1.bit.ECAP2ENCLK = 0;		// SYSCLKOUT to eCAP2 enabled
	...
	SysCtrlRegs.PCLKCR0.bit.ECANBENCLK = 0;		// SYSCLKOUT/2 to eCAN-B enabled
	...
	SysCtrlRegs.PCLKCR0.bit.SCIAENCLK = 0;		// LSPCLK to SCI-A enabled
	SysCtrlRegs.PCLKCR0.bit.SPIAENCLK = 0;		// LSPCLK to SPI-A enabled
	SysCtrlRegs.PCLKCR0.bit.SCICENCLK = 1;		// LSPCLK to SCI-C enabled
	SysCtrlRegs.PCLKCR0.bit.I2CAENCLK = 0;		// LSPCLK to I2C-A enabled
