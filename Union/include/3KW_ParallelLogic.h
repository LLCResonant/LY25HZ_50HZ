...
//InL_CurrShare for 25Hz COM4 for 50Hz
#define InvL_CurrShare_or_COM4_OFF			GpioDataRegs.GPBCLEAR.bit.GPIO48 = 1;
#define InvL_CurrShare_or_COM4_ON		GpioDataRegs.GPBSET.bit.GPIO48 = 1;
#define COM4_LEVEL			GpioDataRegs.GPADAT.bit.GPIO17
...
struct PARALLEL_REG
{
	...
	float32 f32Theta;//WF 2019.01.07
	float32 f32Theta1;//WF 2019.01.07
};
