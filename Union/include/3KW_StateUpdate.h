...
extern enum	SYS_BYPASS 	 g_Sys_Bypass_State;
...
union  STATE_CHECK 
{
    ...
    struct
    {
		...
		//byte 2
        Uint16  FreVOutH_Fault:1;   			//B0
        Uint16  FreVOutL_Fault:1;    			//B1
		Uint16  Bypwork:1;    			//B2
		Uint16  Bypforce:1;    				//B3
		Uint16  Bypmes:1;    		//B4
		Uint16  InvDrvEnable:1; 				//B5
		Uint16  Inv_SoftStart:1;    							//B6
		Uint16  :1;    							//B7
		//byte 3
