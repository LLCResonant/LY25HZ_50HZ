...
{
	EALLOW;
    GpioCtrlRegs.GPAPUD.bit.GPIO23 = 0;	  	//上拉  DATA
    GpioCtrlRegs.GPADIR.bit.GPIO23 = 1;   	// 输出端口
    GpioCtrlRegs.GPAMUX2.bit.GPIO23 = 0;  	// IO口
    GpioCtrlRegs.GPAQSEL2.bit.GPIO23 = 3; 	// 不同步

    GpioCtrlRegs.GPBPUD.bit.GPIO33 = 0;	  	//上拉  CLK
...
{
    EALLOW;
    GpioCtrlRegs.GPADIR.bit.GPIO23=0;       //Input, SDA
    EDIS;
}
...
{
    EALLOW;
    GpioCtrlRegs.GPADIR.bit.GPIO23=1;       //Output. SDA
    EDIS;
}
