...
void InitECan(void)
{
	...
	/* Configure eCAN RX and TX pins for CAN operation using eCAN regs*/
	    ...
	    /* Configure eCAN for SCC mode - (ready to access mailboxes 0 thru 15)*/
/*	    SCC mode disables time-stamping feature*/
...
//	    ECanaShadow.CANMC.bit.SCB = 1;               //select eCAN Mode
	    ECanaShadow.CANMC.bit.SCB = 0;				 //select SCC mode
...
/* The following block is only for 150 MHz SYSCLKOUT. (75 MHz CAN module clock Bit rate = 125 Kbps
	       See Note at end of file. */
		ECanaShadow.CANBTC.bit.BRPREG = 39;				//BRPREG should >=4 for SAM=1
	...
	//  	ECanaShadow.CANBTC.bit.SJWREG = 0;
	    ...
	    ECanaShadow.CANMC.all = ECanaRegs.CANMC.all;
	    ECanaShadow.CANMC.bit.CCR = 0 ;            // CLEAR CCR = 0
	    ECanaRegs.CANMC.all = ECanaShadow.CANMC.all;
	...
	/* Disable all Mailboxes  */
	    ...
	    PieCtrlRegs.PIEIER9.bit.INTx5 = 1;	// Enable ECana0_INT in PIE group 9
...
// Comment out other unwanted lines.
    ...
    GpioCtrlRegs.GPAPUD.bit.GPIO30 = 0;     // Enable pull-up for GPIO18 (CANRXA)
    GpioCtrlRegs.GPAPUD.bit.GPIO31 = 0;     // Enable pull-up for GPIO19 (CANTXA)

/* Set qualification for selected CAN pins to asynch only */
// Inputs are synchronized to SYSCLKOUT by default.
// This will select asynch (no qualification) for the selected pins.

    GpioCtrlRegs.GPAQSEL2.bit.GPIO30 = 3;   // Asynch qual for GPIO18 (CANRXA)

/* Configure eCAN-A pins using GPIO regs*/
// This specifies which of the possible GPIO pins will be eCAN functional pins.

    GpioCtrlRegs.GPAMUX2.bit.GPIO30 = 3;    // Configure GPIO18 for CANRXA operation
    GpioCtrlRegs.GPAMUX2.bit.GPIO31 = 3;    // Configure GPIO19 for CANTXA operation
...
void BaudRate(Uint16 BRP)
{
  ...
  // See Note at end of file.
    ...
    ECanaShadow.CANBTC.bit.BRPREG = BRP;
    ECanaShadow.CANBTC.bit.TSEG2REG = 2;
    ECanaShadow.CANBTC.bit.TSEG1REG = 10;
    ECanaRegs.CANBTC.all = ECanaShadow.CANBTC.all;
